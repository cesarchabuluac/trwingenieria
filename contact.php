                        ...
                        <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>
                                        <li><i class="fa fa-phone"></i> <a href="tel:9932424730" style="color: white;">993-242-4730</a> | <a href="tel:9932196440" style="color: white;">993-219-6440</a></li>
                                        <li><i class="fa fa-envelope"></i> <a href="mailto:trea@trwingenieria.com" style="color: white;">trea@trwingenieria.com</a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-1">
                                <div class="logo">
                                    ...
                                    <a href="index.html" class="big-logo">
                                        <img src="assets/img/logo/logo.png"  alt="TRW Ingeniería">                                        
                                    </a>
                                    <!-- logo-2 -->
                                    <a href="index.html" class="small-logo">
                                        <img src="assets/img/logo/logo.png" alt="TRW Ingeniería" height="50">                                        
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-8">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html">
                                        <img src="assets/img/logo/logo-footer.png" alt="TRW Ingeniería">                                        
                                    </a>
                                </div>
                            ...
                            <div class="single-footer-caption mb-50">
                                <div class="footer-tittle">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="tel:9932196440">993-219-6440</a></li>
                                        <li><a href="mailto:trea@trwingenieria.com"><i class="fa fa-envelope"></i> trea@trwingenieria.com</a></li>
                                        <li><a href="mailto:arturo.rea@trwingenieria.com">arturo.rea@trwingenieria.com</a></li>
                                    </ul>                                    
                                </div>
                            </div>
                        </div>
